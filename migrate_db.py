...
DB_CONNECTION_STR = 'postgresql://postgres:YOUR_PASSWORD@localhost:5432/fire_monitoring_db'
...
def migrate():
    ...
    for sql_table, firebase_collection in TABLE_MAP.items():
        ...
        try:
            ...
            df = df.applymap(lambda x: str(x) if isinstance(x, (datetime.date, datetime.datetime)) else x)
            ...
            print(f"    Found {total_records} rows. Uploading to '{firebase_collection}'...")
