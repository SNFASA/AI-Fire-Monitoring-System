...
DATABASES = {
    'default': {
        ...
        'NAME': 'fire_monitoring_db',
        'USER': 'postgres',
        'PASSWORD': 'SYED13@nabil15',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "AI Fire Monitoring Admin",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "AI Fire Monitoring",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "images/bomba.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "images/bomba.png",

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "images/bomba.png",
    ...
    "welcome_sign": "Welcome to the AI Fire Monitoring Admin",

    # Copyright on the footer
    "copyright": "AI Fire Monitoring",
    ...
    "icons": {
        ...
        "sensors.userprofile":"fas fa-user",
        "sensors.dutyassignment":"fas fa-clipboard-list",
        "sensors.houselayout":"fas fa-home",
        "sensors.firestation":"fas fa-house-fire",
        "sensors.report":"fas fa-file-alt",
        "sensors.maintenance":"fas fa-wrench",
