...
class NasaFirmsServicesTests(TransactionTestCase):
    ...
    def setUp(self):
        ...
        poly_geom = "MULTIPOLYGON(((101.0 1.0, 104.0 1.0, 104.0 4.0, 101.0 4.0, 101.0 1.0)))"
    ...
    @patch("sensors.services.requests.get")
    def test_successful_fetch_filter_and_duplicate_prevention(self, mock_get, mock_process):
        ...
        self.assertEqual(result_2, "NASA connected successfully, but no new hotspots to add.")
