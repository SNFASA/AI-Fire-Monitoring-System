...
from sensors.models import Address, Report, Sensor, SensorDataLog, UserProfile
...
class ComprehensiveApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.profile = UserProfile.objects.create(
            user=self.user, role="public", phone_number="+601139771785"
        )
        ...
        self.sensor = Sensor.objects.create(
            id=80, name="Simulated Unit", owner=self.profile
        )
