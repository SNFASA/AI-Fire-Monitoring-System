...
from sensors.models import SatelliteHotspot, FireStation, Report # Adjust imports if needed
...
def check_coverage(fire_lat, fire_lon):
    ...
    for station in stations:
        ...
        print(f"Checking Station: {station.name} | Distance: {distance:.2f}m | Coverage Radius: {coverage_radius:.2f}m")
